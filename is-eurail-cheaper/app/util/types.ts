...
export type Result = { price: number, length: number, legs: LatLng[][] | undefined, departure: Date, link: string, incomplete: boolean }
export type Endpoint = [Result[], Dispatch<any>, StaticImageData]
export type EndpointResult = { price: string, currency: string, length: string, legs: { location: Location }[][], departure: Date, link: string, incomplete: boolean }
